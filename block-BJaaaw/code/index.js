...
num1 > num2 ? alert("num1 has max value") : alert("num2 has max value");
/*
...
if (salery <= 20000) {
  ...
  alert(`your in-hand amount is ${20000 - tax}`);
} else if (salery <= 40000) {
  let tax = (salery * 20) / 100;
  alert(`your in-hand amount is ${40000 - tax}`);
} else if (salery > 50000) {
  let tax = (salery * 30) / 100;
  alert(`your in-hand amount is ${50000 - tax}`);
} else {
